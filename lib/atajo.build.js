...
var builder = {
    ...
    build: function(file, version, cb) {
        ...
        _.BASE_DIR = path.join(__dirname, '../', '../', 'dist', version.BASEVERSION);
    ...
    processTS: function(version) {
        ...
        return new Promise((resolve, reject) => {
            ...
            const webpack = spawn(/^win/.test(process.platform) ? 'webpack.cmd' : 'webpack', []);
    ...
    compileSass: function(files, cb) {
        ...
        for (var f in files) {
            ...
            var includePaths = [
                ...
                path.join(__dirname, '../', '../', 'node_modules', 'ionicons', 'dist', 'fonts'),
                path.join(__dirname, '../', '../', 'node_modules', 'ionicons', 'dist', 'svg'),
                path.join(__dirname, '../', '../', 'node_modules', 'ionic-angular', 'fonts'),
                path.join(__dirname, '../', '../', 'node_modules', 'ionic-angular', 'components'),
                path.join(__dirname, '../', '../', 'node_modules', 'ionic-angular', 'themes'),
