...
_io = {
    ...
    init: function(RELEASE, URI) {
        ...
        _.TARGET_CHUNK_SIZE = _.CONFIG.TARGET_CHUNK_SIZE || 100000;
    ...
    initHandler: function(handlerName, obj) {
        ...
        if (_.HANDLER_CACHE[handlerName]) {
            var HANDLER = _.HANDLER_CACHE[handlerName];
            ...
            try {
                ...
                atajo.log.e("ERROR SENDING TO HANDLER : " + e);
                delete _.HANDLER_CACHE[handlerName];
                _.initHandler(handlerName, obj);
            ...
            var exists = fs.exists(fnam, function(exists) {
                    ...
                    */
                    ...
                    HANDLER.on('message', function(msg) {
                        ...
                        if (typeof msg.type == 'undefined') {
                            ...
                            atajo.log.d("HANDLER RESPONSE TYPE NOT RECOGNIZED : " + msg.type);
                        }
                ...
                if (obj.CHUNKED) {
                    ...
                    try {
                        ...
                        for (var i = 0; i < 50; i++) {
                            ...
                            if ((mult < len) && (mult < _.TARGET_CHUNK_SIZE)) {
                                chunkSize++;
                            } else {
                                break;
                            }
