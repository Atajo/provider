...
_io = {
    ...
    init: function(RELEASE, URI) {
        ...
        _.SOCKET.on('event', function(data) {
            ...
            try {
                ...
                switch (data.type) {
                    case 'clientConnect':
                        require('../../hooks/onDeviceConnect.js').evt();
                        break;
                    case 'clientDisconnect':
                        require('../../hooks/onDeviceDisconnect.js').evt();
                        break;
                    case 'syncCancel':
                        require('../../hooks/onSyncCancel.js').evt();
                        break;

                }

            } catch (e) {
                atajo.log.e("COULD NOT PROCESS EVENT FROM CORE : " + e);
            }
        ...
        //UNAUTHORIZED. CORE WILL DROP SOCKET. MAY AS WELL EXIT. 
                ...
                */
                ...
                HANDLER.on('message', function(msg) {
                    ...
                    if (typeof msg.type == 'undefined') {
                        ...
                        atajo.log.d("GOT API REQUEST FROM HANDLER")
    ...
    processConnect: function() {
        ...
        atajo.log.n();
        atajo.log.i("<-----[ ATAJO PROVIDER " + currentProviderVersion + " ]--[ " + _.RELEASE + " : " + _.VERSION.ID + " ]--[ STARTED ON " + _.HOSTNAME + " ]--[ CONNECTED TO " + _.URI + ' ]----->');
        atajo.log.n();
        ...
        _.SOCKET.emit('ATAJO.PROVIDER.CONFIGURE', _PROVIDER);
        ...
        //CONFIGURE CODE UPLOADS
        require('./atajo.code.js').init(_.SOCKET, _.VERSION);
